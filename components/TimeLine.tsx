...
const TimeLine = () => {
  return (
    <div className="antialiased text-gray-300 mt-24 md:mt-20">
      <div
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="relative pt-2 xs:pr-20 xs:pt-0 md:w-1/2 md:mr-auto md:pr-16">
            <div
              aria-hidden="true"
              className="absolute inset-0 right-10 h-4 w-4 transform rotate-45 bg-black xs:top-3 xl:top-5 xs:right-[4.5rem] md:right-14"
            />
        ...
        <div className="relative z-10">
          ...
          <div className="relative pt-2 xs:pr-20 xs:pt-0 md:w-1/2 md:pr-0 md:mr-0 md:pl-16">
            <div
              aria-hidden="true"
              className="absolute inset-0 right-10 h-4 w-4 transform rotate-45 bg-black xs:top-3 xs:right-[4.5rem] xl:top-5 md:right-auto md:left-14"
            />
            <div className="bg-black py-2 px-3 rounded-md shadow-md ">
              <h1 className="text-xs md:text-sm lg:text-lg xl:text-sm">
                Title
        ...
        <div className="relative z-10">
          ...
          <div className="relative pt-2 xs:pr-20 xs:pt-0 md:w-1/2 md:mr-auto md:pr-16">
            <div
              aria-hidden="true"
              className="absolute inset-0 right-10 h-4 w-4 transform rotate-45 bg-black xs:top-3 xs:right-[4.5rem] xl:top-5 md:right-14"
            />
            <div className="bg-black py-2 px-3 rounded-md shadow-md ">
              <h1 className="text-xs md:text-sm lg:text-lg xl:text-sm">
                Title
